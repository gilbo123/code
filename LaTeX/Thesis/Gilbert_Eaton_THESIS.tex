...
This research and development performed during the undertaking of this project has contributed the following items in terms of research, application, and industry partnerships:

\begin{itemize}
	\item Research and experimentation into production-level lighting quality showed that completely diffuse, cross-polarised illumination removes all specular reflections whilst maintaining fine-grained features for strawberry containers is achievable. 
	\item Confirmed the validity of grading multiple strawberries per image (after packing), increasing throughput potential and reducing damaging human handling.
	...
	\item Proof-of-concept for invisible bruise detection in the NIR region using a CMOS camera, providing a cheap and reliable method. 
	\item E
	\item F
	\item ...
\end{itemize}
...
\begin{itemize}
	...
	\item Chapter \ref{sec:III} - Systematic Reconfiguration Toward a Robust Production Environment Design
...
Design and development of the software and hardware frameworks have been performed with experimental results indicating the validity of using machine vision for quality inspection of full punnets of strawberries on a production line. Cross-polarisation and diffuse lighting arrangement have shown that, when sufficient illumination intensity is provided, eliminating specular reflections completely can be achieved, without diminishing image quality.

The rate of acquisition and processing have been analysed, indicating the shutter speeds and illumination intensity required for optimal image quality. Individual and total power consumption is detailed in Table \ref{tab:DC_power_table}, identifying high-power DC supply requirements. 
...
The enclosure has transitioned from bench prototype to production system allowing the punnets to flow through both the SQA and Heat-seal machines. The conveyors were sourced fro the ex-production stock and retrofit to the enclosure allowing each container to pass through the mid section between the two sets of cameras. LED and halogen lighting placed at the entry and exit ends of the enclosure provide the relevant wavelengths for each of the cameras required spectra.
...
\chapter{Systematic Reconfiguration Toward a Robust Production Environment Design}
\label{sec:III}
...
The cleaning and maintenance problems seen in the first two seasons....
...
\subsection{South Australia Production - Season 4}
...
Improvements in image processing techniques allowed the application to ...
