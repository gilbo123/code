...
\begin{figure}[h]
	...
	\caption{A thermal image apple with bruises \cite{baranowski} showing the Long Wavelength Infrared (LWIR) part of the electromagnetic spectrum. In this range, sensors can detect thermal properties at room temperature}
	\label{fig:thermal}
\end{figure}%
...
\begin{itemize}
	\item Design and Construction - Chapter \ref{sec:I} 
	\item Production Integration  - Chapter \ref{sec:II}
	\item System Reconfiguration - Chapter \ref{sec:III}
	\item Linux and Deep Learning - Chapter \ref{sec:IV}
\end{itemize}
