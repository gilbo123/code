...
\begin{longtable}{p{5cm}p{10cm}}
	\caption{Table of Requirements for the Strawberry Vision System}
...
\begin{figure}[h]
	...
	\end{subfigure}%
	\caption{(a) Strawberries with dominant specular reflections reducing the ability to analyse pixels, and (b) Electromagnetic polarisation. A circular or randomly polarised source becomes a single polarity after passing through the material.}
	\label{}
\end{figure}
...
An independant power supply was needed to power the prototype, which at this stage, only included the top illumination cluster. The $12V/5A$ power supply was only able to power either the LEDs or halogens for testing purposes, and not both at once due to the power limitation.  


\subsection{Strawberry Quality Assurance (SQA) System Design}


A Computer Aided Design (CAD) generated cross-section of the proposed SQA system is shown in Figure \ref{fig:cross_sec} 
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.6\linewidth]{images/enclosure_3.jpg}
