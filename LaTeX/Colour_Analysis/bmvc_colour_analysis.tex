...
\addauthor{Gilbert Eaton}{gilbert.eaton@griffithuni.edu.au}{1}
\addauthor{Andrew Busch}{a.busch@griffith.edu.au}{1}
\addauthor{Rudi Bartels}{r.bartels@griffith.edu.au}{1}
\addauthor{Yongsheng Gao}{yongsheng.gao@griffith.edu.au}{1}
...
\runninghead{G.Eaton, A.Busch, R.Bartels, Y.Gao}{BMVC Author Guidelines}
...
\begin{figure}[ht]
	...
	\begin{subfigure}
		\centering
		\includegraphics[width=0.5\linewidth]{images/SQA_v2.png}
	...
	\begin{subfigure}
		\centering
		\includegraphics[width=0.5\linewidth]{images/QAS_cross_sec.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.05]{images/enclosure_front.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.35]{images/CIELab-colour-space.jpg}
...
%\begin{tabular}{cc}
%	(a)&(b)\\
%	\bmvaHangBox{\fbox{\includegraphics[width=4cm]{images/zoom_image.jpg}}\\}&
%	\bmvaHangBox{\fbox{\includegraphics[width=4cm]{images/hsv_contour.jpg}}}\\
%
%	(c)&(d)\\
%	\bmvaHangBox{\fbox{\includegraphics[width=4cm]{images/pow_image.jpg}}\\}&
%	\bmvaHangBox{\fbox{\includegraphics[width=4cm]{images/result.jpg}}}
%	
%\end{tabular}
...
%	\begin{subfigure}
%		\centering
%		\includegraphics[width=.5\linewidth]{images/over_berries.jpg}
%		\caption{}
%		\label{fig:over_berries}
%	\end{subfigure}%
%	\begin{subfigure}
%		\centering
%		\includegraphics[width=.5\linewidth]{images/over_hue.jpg}
%		\caption{}
%		\label{fig:over_hue}
%	\end{subfigure}%
%	
%	\begin{subfigure}
%		\centering
%		\includegraphics[width=.5\linewidth]{images/over_diff_hue.jpg}
%		\caption{}
%		\label{fig:over_diff}
%	\end{subfigure}%
%	\begin{subfigure}
%		\centering
%		\includegraphics[width=.5\linewidth]{images/over_light.jpg}
%		\caption{}
...
%	\begin{subfigure}
%		\centering
%		\includegraphics[width=.5\linewidth]{images/over_light_diff.jpg}
%		\caption{}
%		\label{fig:over_light_diff}
%	\end{subfigure}%
%	\begin{subfigure}
%		\centering
%		\includegraphics[width=.5\linewidth]{images/over_result.jpg}
%		\caption{}
