...
# Class #430 is "basketball"
object_type_to_fake = 430

# Load the image to hack
img = image.load_img("snail.jpeg", target_size=(299, 299))
...
while cost < 0.80:
    ...
    print("Model's predicted likelihood that the image is a basketball: {:.8}%".format(cost * 100))
